...
export const SPORTS_PRESETS: SportPreset[] = [
  {
    ...
    leagues: [
      ...
      {
        id: "chl",
        name: "CHL (Canadian Hockey League)",
        teams: [
          ...
          { name: "Chicoutimi Sagueneens", display: "Chicoutimi" },
      ...
      },
      {
        ...
        teams: [
          { name: "CSKA Moscow", display: "CSKA Moscow" },
          { name: "SKA Saint Petersburg", display: "SKA St. Petersburg" },
          { name: "Ak Bars Kazan", display: "Ak Bars Kazan" }
        ]
      }
    ]
  },
    ...
    leagues: [
      ...
      },
      {
        ...
        teams: [
          ...
          { name: "Toledo Mud Hens", display: "Toledo Mud Hens" }
        ]
      }
    ]
  },
